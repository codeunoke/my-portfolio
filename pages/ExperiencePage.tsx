    ...
    <div className="min-h-screen py-20 px-4 container mx-auto relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="mb-16 md:mb-24">
          <div className="inline-flex items-center gap-3 mb-6 px-4 py-2.5 rounded-full border border-red-600/20 bg-gradient-to-r from-red-600/10 to-red-600/5 backdrop-blur-sm text-red-500 text-xs font-bold tracking-[0.2em] uppercase">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-4 text-white tracking-tighter leading-tight">
                WORK
                <span className="block text-red-500 text-4xl md:text-5xl mt-2">Experience</span>
              </h1>
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-0 md:left-1/3 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-red-600/20 to-transparent hidden md:block"></div>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start relative">
                  ...
                  <div className="absolute left-0 md:left-1/3 top-6 -translate-x-1/2 hidden md:block">
                    <div className={`w-4 h-4 rounded-full border-2 transition-all duration-300 ${
                      idx === 0 
                        ? 'bg-red-600 border-red-600 animate-pulse shadow-lg shadow-red-600/20' 
                        : 'bg-slate-900 border-slate-700 group-hover:border-red-600'
                    }`}></div>
                  </div>
                  ...
                  <div className="w-full md:w-1/3 pl-0 md:pl-12">
                    <div className="sticky top-32">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-red-400 group-hover:to-green-400 transition-all duration-300 mb-2">
                        {exp.company}
                      </h3>
                      ...
                      <div className={`mt-6 transition-all duration-500 overflow-hidden ${
                        ...
                        <div className="flex flex-wrap gap-2">
                          {exp.skills.slice(0, 3).map((skill, i) => (
                            <span 
                              key={i}
                              className="text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-red-600/10 to-green-600/10 text-red-500 px-3 py-1.5 rounded-full border border-red-600/20"
                            >
                              {skill}
                            </span>
                          ))}
                  ...
                  <div className="w-full md:w-2/3">
                    <div className={`glass-card p-8 md:p-10 rounded-3xl border transition-all duration-500 transform group-hover:scale-[1.02] ${
                      idx === 0 
                        ? 'border-red-600/20 bg-gradient-to-br from-red-600/5 via-transparent to-green-600/5' 
                        : 'border-white/5 bg-gradient-to-br from-white/5 to-white/[0.02] group-hover:border-red-600/20'
                    }`}>
                      <div className="flex items-start gap-4">
                        <div className="hidden md:block">
                          <div className="p-3 rounded-2xl bg-gradient-to-br from-red-600/10 to-green-600/10 border border-red-600/20">
                            ...
                            {exp.description.map((item, i) => (
                              ...
                              >
                                <span className="flex-shrink-0 mt-1.5">
                                  <div className="w-2 h-2 rounded-full bg-gradient-to-r from-red-600 to-green-600 group-hover/item:scale-125 transition-transform"></div>
                                </span>
        ...
        <div className="mt-24 pt-16 border-t border-white/10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a 
              href="#contact"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white font-bold rounded-full transition-all hover:scale-105 active:scale-95 shadow-xl shadow-red-600/25 hover:shadow-2xl hover:shadow-red-600/40"
            >
