      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start mb-20">
          ...
          <div className="space-y-12">
            <div>
              <span className="inline-block text-sm font-semibold text-red-500 uppercase tracking-wider mb-4">
                Journey
              </span>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 text-white tracking-tight leading-none">
                My Story
              </h1>
              <div className="h-1 w-24 bg-gradient-to-r from-red-600 to-green-600 rounded-full mb-8"></div>
            </div>

            <div className="space-y-8 text-slate-300 text-lg leading-relaxed">
              <div className="relative pl-6 border-l-2 border-red-600/30">
                <p className="mb-2">
                  My journey began at{' '}
                  <span className="font-semibold text-white bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent">
                    Kabarak University
                  </span>{' '}
              ...
              <div className="relative pl-6 border-l-2 border-green-600/30">
                <p className="mb-2">
              ...
              <div className="relative pl-6 border-l-2 border-red-600/30">
                <p className="mb-2">
                  Currently, at{' '}
                  <span className="font-semibold text-red-500">Samco Security Services</span>, I leverage Power BI 
                  and Python to drive operational efficiency. My{' '}
                  <span className="font-semibold text-white underline decoration-red-600 decoration-2 underline-offset-4">
                    IBM Data Analyst
                  </span>{' '}
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="glass-card p-8 rounded-2xl border border-white/10 backdrop-blur-sm bg-white/5 hover:bg-white/10 transition-all duration-300 group hover:border-red-600/30">
                <div className="text-red-500 font-black text-3xl mb-2 group-hover:text-red-400 transition-colors">2020</div>
              ...
              <div className="glass-card p-8 rounded-2xl border border-white/10 backdrop-blur-sm bg-white/5 hover:bg-white/10 transition-all duration-300 group hover:border-green-600/30">
                <div className="text-green-500 font-black text-3xl mb-2 group-hover:text-green-400 transition-colors">IBM</div>
                <div className="text-sm font-semibold uppercase text-slate-400 tracking-wider group-hover:text-slate-300 transition-colors">
                  Certified Analyst
                </div>
          ...
          <div className="space-y-8">
            <div className="text-right">
              <span className="inline-block text-sm font-semibold text-green-500 uppercase tracking-wider mb-4">
                Expertise
              </span>
              <h2 className="text-4xl md:text-5xl font-black mb-6 text-white tracking-tight uppercase">
                Technical Mastery
              </h2>
              <div className="h-1 w-24 bg-gradient-to-r from-green-600 to-green-700 rounded-full ml-auto mb-8"></div>
        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="h-1 w-24 bg-gradient-to-r from-amber-600 to-red-600 rounded-full mb-8"></div>
